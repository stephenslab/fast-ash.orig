...
lprobsum = c(0)
add_to_wsum_direct(lprobsum, wsum,pi,lik,0,nsamp-1)
wsum = rep(0,length(pi))
lprobsum = c(0)
add_to_wsum(lprobsum, wsum,pi,lik,0,nsamp-1,0,0,tol=1e-5)
wsum
...
wsum = rep(0,length(pi))
lprobsum = 0
add_to_wsum(lprobsum, wsum,pi,lik,11,2000,0,0,tol=1e-5)
wsum
```
